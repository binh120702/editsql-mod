...
# python3 preprocess.py --dataset=cosql --pi_working

# 2. train and evaluate.
#    the result (models, logs, prediction outputs) are saved in $LOGDIR

GLOVE_PATH="/home/dapici/glove.840B.300d.txt" # you need to change this
...
CUDA_VISIBLE_DEVICES=0 python3 run.py --raw_train_filename="data/cosql_data/train.pkl" \
          ...
          --save_file="/home/dapici/editsql/logs_cosql_cdseq2seq/save_14"
