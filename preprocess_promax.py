...
def read_data_json(split_json, interaction_list, database_schemas, column_names, output_vocab, schema_tokens, remove_from):
  ...
  return interaction_list
def read_data_json_promax(split_data, interaction_list, database_schemas, column_names, output_vocab, schema_tokens, remove_from):
...
def read_cosql_pi_dev_only(cosql_data, database_schemas, column_names, output_vocab, schema_tokens, remove_from):
  
  interaction_list_dev = {}
  interaction_list_dev = read_data_json_promax(cosql_data, interaction_list_dev, database_schemas, column_names, output_vocab, schema_tokens, remove_from)

  return interaction_list_dev
...
def read_db_split_dev_only(data_dir):
  dev_database = []
  with open(os.path.join(data_dir,'dev_db_ids.txt')) as f:
    for line in f:
      dev_database.append(line.strip())
...
def preprocess(cosql_data, schema_tokens, column_names, database_schemas):
  ...
  interaction_list_dev = read_cosql_pi_dev_only(cosql_data, database_schemas, column_names, output_vocab, schema_tokens, remove_from=True)
